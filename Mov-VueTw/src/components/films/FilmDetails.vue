            ...
            <div class="ml-24  ">
                ...
                <span class="text-green-200 text-xl flex mt-4 border flex-col pl-2">
                    ...
                    <div class="flex"> 
                        ...
                        {{ (video.vote_average * 10).toFixed(2) }}%  |  Date de sortie: {{ video.release_date  || video.first_air_date }}  |
                    </div> 
                    <div class="flex-inline">
                       ...
                       <div class="">
                        ...
                        Dernier épisode diffusé: numéro épisode et titre : 7 le réveil de Dai | {{ video.last_episode_to_air.episode_number }} - {{ video.last_episode_to_air.name }}<br>
